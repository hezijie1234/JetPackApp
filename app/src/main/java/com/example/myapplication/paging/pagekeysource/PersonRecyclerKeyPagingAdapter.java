...
public class PersonRecyclerKeyPagingAdapter extends PagedListAdapter<Person, PersonRecyclerKeyPagingAdapter.MyRecyclerViewHolder> {
    ...
    public PersonRecyclerKeyPagingAdapter() {
        super(DIFF_STUDENT);
    }
