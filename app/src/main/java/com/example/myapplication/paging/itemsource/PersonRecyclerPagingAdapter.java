...
import com.example.myapplication.paging.RecyclerPagingAdapter;

public class PersonRecyclerPagingAdapter extends PagedListAdapter<Person, PersonRecyclerPagingAdapter.MyRecyclerViewHolder> {
    ...
    public PersonRecyclerPagingAdapter() {
        super(DIFF_STUDENT);
    }
